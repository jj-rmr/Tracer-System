...
export default function GraduateTracerStudy() {
  ...
  return (
    <div className="h-fit">
      ...
      <p className="text-foreground mb-6">{currentPage == 1 ? "General Information" : "Educational Attainment"}</p>
    <form action="/api/forms/form-a/json" onSubmit={handleSubmit} className="w-full place-self-center lg:max-w-120 flex flex-col gap-4 mb-8 items-center">
      {currentPage === 1 && (
        <>
          <div className="flex flex-col gap-1 w-full">
            <label htmlFor="firstName" className="font-semibold text-accent">First Name <span className="text-rose-500">*</span></label>
            <input
              type="text"
              id="firstName"
              name="firstName"
          ...
          <div className="flex flex-col gap-1 w-full">
            <label htmlFor="middleName" className="font-semibold text-accent">Middle Name</label>
            <input
              type="text"
              id="middleName"
              name="middleName"
          ...
          <div className="flex flex-col gap-1 w-full">
            <label htmlFor="lastName" className="font-semibold text-accent">Last Name <span className="text-rose-500">*</span></label>
            <input
              type="text"
              id="lastName"
              name="lastName"
          ...
          <div className="relative flex flex-col gap-1 w-full">
            <label htmlFor="contactNumber" className="font-semibold text-accent">Contact Number <span className="text-rose-500">*</span></label>
            <input
              type="tel"
              id="contactNumber"
              name="contactNumber"
              ...
              required
            />
            <p className="absolute bottom-4.25 left-4 text-foreground/50">+63</p>
          </div>
      ...
      <div className="flex flex-col w-full items-center">
        {toast && <Toast message={toast} type={toastType} setType={setToastType} onClose={() => setToast("")} />}
      </div>
    </form>
    </div>
  );
