...
// import { getPaginatedAccounts } from "@/app/api/appwrite/appwrite";
...
//   try {
//     const data = await getPaginatedAccounts(limit, offset);
//     accounts = data.users;
...
//               A list of accounts registered in the system.
//             </p>
//           </div>
...
//                               {account.labels.map((label: string) => (
//                                 <span
//                                   key={label}
